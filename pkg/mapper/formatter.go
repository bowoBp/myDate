...
func (m Mappers) typeIsArray(vals interface{}) bool {
...
func (m Mappers) ContainByStructField(target interface{}, fieldName string, val interface{}) bool {
...
func (m Mappers) UniqueByStructField(vals interface{}, fieldName string) interface{} {
...
func (m Mappers) SortingByStructField(vals interface{}, fieldName string, sorting SortingDirection) interface{} {
	pVal := reflect.ValueOf(vals)
...
func (m Mappers) ParseServiceDurationFormat(d string) (string, error) {
	ds := strings.Split(d, ":")
